...
<<<<<<< Updated upstream
let testAndTree = parseFromFile "test/test_alternative.gc";;
=======
let testAndTree = parseFromFile "test/test_tc_localDec2.gc";;

let testAndTree2 = parseFromFile "test/test_and.gc";;
...
let _ = exec "test/test_alternative_stop.gc";;
